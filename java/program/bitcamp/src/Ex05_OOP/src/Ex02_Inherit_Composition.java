...
class Triangle extends Shape {
	...
	Triangle() {
		...
		//y = new Point(30, 40);
		//z = new Point(50, 60);
		this(new Point(10, 20),new Point(30, 40),new Point(50, 60)); // point에  x , y값이 들어간다.
	}
...
class Triangle2 extends Shape{
	...
	Triangle2(Point[] pointarray){ // 기본생성자에  선언한것을 파라미터에 똑같이 적는다. 
		this.pointarray = pointarray;
	}
	
	
	Triangle2() {
		this(new Point[] {new Point(10, 20) , new Point(30, 40), new Point(50, 60)}); // this생성자로   생성를함 
	}
